...
criuRestoreInitializeLib(J9JavaVM *vm, J9JVMTIEnv *j9env)
{
	...
	processAgentLibraryFromArgsList(vm, criuRestoreArgsList, VMOPT_AGENTLIB_COLON, FALSE);
	processAgentLibraryFromArgsList(vm, criuRestoreArgsList, VMOPT_AGENTPATH_COLON, FALSE);
