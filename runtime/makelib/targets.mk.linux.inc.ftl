...
ifndef UMA_DO_NOT_OPTIMIZE_CCODE
  ...
  <#else>
    <#if uma.spec.processor.amd64>
      UMA_OPTIMIZATION_CFLAGS += -O0 -g3 -fno-strict-aliasing
    <#elseif uma.spec.processor.x86>
      UMA_OPTIMIZATION_CFLAGS += -O0 -g3 -fno-strict-aliasing -march=pentium4 -mtune=prescott -mpreferred-stack-boundary=4
    <#elseif uma.spec.processor.arm>
      UMA_OPTIMIZATION_CFLAGS += -g -O0 -g3 -fno-strict-aliasing $(ARM_ARCH_FLAGS) -Wno-unused-but-set-variable
    <#elseif uma.spec.processor.ppc>
      UMA_OPTIMIZATION_CFLAGS += -O0 -g3
    ...
    <#elseif uma.spec.processor.s390>
      UMA_OPTIMIZATION_CFLAGS += -O0 -g3 -mtune=z10 -march=z9-109 -mzarch
    <#else>
  ...
  <#else>
    <#if uma.spec.processor.amd64>
      UMA_OPTIMIZATION_CXXFLAGS += -O0 -g3 -fno-strict-aliasing
    <#elseif uma.spec.processor.x86>
      UMA_OPTIMIZATION_CXXFLAGS += -O0 -g3 -fno-strict-aliasing -march=pentium4 -mtune=prescott -mpreferred-stack-boundary=4
    <#elseif uma.spec.processor.arm>
      UMA_OPTIMIZATION_CXXFLAGS += -g -O0 -g3 -fno-strict-aliasing $(ARM_ARCH_FLAGS) -Wno-unused-but-set-variable
    <#elseif uma.spec.processor.ppc>
      UMA_OPTIMIZATION_CXXFLAGS += -O0 -g3
      <#if uma.spec.flags.env_littleEndian.enabled && uma.spec.type.linux>
        UMA_OPTIMIZATION_CXXFLAGS += -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=1
      </#if>
    <#elseif uma.spec.processor.s390>
      UMA_OPTIMIZATION_CXXFLAGS += -O0 -g3 -mtune=z10 -march=z9-109 -mzarch
    <#else>
...
<#if uma.spec.processor.ppc>
  ifdef USE_PPC_GCC
    PPC_GCC_CXXFLAGS += -O0 -g3 -fno-strict-aliasing
  endif
</#if>
