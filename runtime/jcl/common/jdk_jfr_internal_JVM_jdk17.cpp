...
Java_jdk_jfr_internal_JVM_setHandler(JNIEnv *env, jobject obj, jclass eventClass, jobject handler)
{
	...
	void *eventHandlerAddr = vmFuncs->staticFieldAddress(currentThread, J9VMJAVALANGCLASS_VMREF(currentThread, J9_JNI_UNWRAP_REFERENCE(eventClass)), (U_8 *)J9UTF8_DATA(&eventHandlerName), J9UTF8_LENGTH(&eventHandlerName), (U_8 *)J9UTF8_DATA(&eventHandlerSig), J9UTF8_LENGTH(&eventHandlerSig), &definingClass, NULL, 0, NULL);
