...
typedef struct J9InternalVMFunctions {
	...
	I_64 (*getTypeIDUTF8)(struct J9VMThread *currentThread, const struct J9UTF8 *className);
	I_64 (*getTypeID)(struct J9VMThread *currentThread, struct J9Class *className);
#endif /* defined(J9VM_OPT_JFR) */
#if defined(J9VM_OPT_SNAPSHOTS)
