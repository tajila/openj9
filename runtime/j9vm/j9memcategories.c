...
#endif /* OMR_OPT_CUDA */
OMRMEM_CATEGORY_2_CHILDREN("Classes", J9MEM_CATEGORY_CLASSES, J9MEM_CATEGORY_CLASSES_SHC_CACHE, J9MEM_CATEGORY_CUSTOM);
OMRMEM_CATEGORY_NO_CHILDREN("Shared Class Cache", J9MEM_CATEGORY_CLASSES_SHC_CACHE);
OMRMEM_CATEGORY_NO_CHILDREN("***CUSTOM***", J9MEM_CATEGORY_CUSTOM);
...
CATEGORY_TABLE_ENTRY(J9MEM_CATEGORY_CUSTOM),
};
